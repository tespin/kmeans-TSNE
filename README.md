...
## Requirements
This has been tested and is working with [openFrameworks] (http://openframeworks.cc/download/ "openFrameworks") 0.9.8. Download the latest stable release, along with the *master* branches of the following addons:
